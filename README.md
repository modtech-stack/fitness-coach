...
**Stage 2.1 — Training Workflow UX.**
...
Подготовленная программа Stage 2.1 добавляется пользователем явно и не генерируется AI. Новые недели не заполняются автоматически. Пока не реализованы GPT Program Builder, OpenAI API, Training Engine, wearable-интеграции, логика разминки и расширенная аналитика.
