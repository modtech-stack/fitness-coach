    ...
    <div className="space-y-6">
      ...
      <section className="surface-card">
        ...
        <p className="mt-2 mb-7 text-sm leading-6 text-slate-600">
          Опишите своими словами всё, что может повлиять на выбор
          упражнений, нагрузку или восстановление. Отдельными записями
          можно добавить боль или травму, доступное время, оборудование
          и бытовые условия.
        </p>
        <ConstraintForm
